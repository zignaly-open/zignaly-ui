...
function Button({
  ...
  const renderLeftElement = useMemo(() => (
    typeof leftElement === 'function' ? leftElement : <styled.Icon src={leftElement} alt={caption} />
  ), [leftElement]);
  ...
  const renderRightElement = useMemo(() => (
    typeof rightElement === 'function' ? rightElement : <styled.Icon src={rightElement} alt={caption} />
  ), [rightElement]);
